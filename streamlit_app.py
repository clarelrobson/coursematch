...
import os
import nltk
import shutil  # For cleaning up broken downloads

# Set up NLTK data directory
nltk_data_dir = os.path.join(os.getcwd(), "nltk_data")
if os.path.exists(nltk_data_dir):  # Clean up existing folder if corrupted
    shutil.rmtree(nltk_data_dir)

os.makedirs(nltk_data_dir, exist_ok=True)
nltk.data.path.append(nltk_data_dir)  # Ensure NLTK searches here

# Force redownload of NLTK resources
